...
class CodeReviewEnv:
    ...
    def reset(self, task_type: Optional[str] = None) -> CodeReviewObservation:
        # Pick from all 5 task types
        task_types = ["identify_bug", "suggest_fix", "full_review", "security_audit", "performance_refactor"]
    ...
    def step(self, action: CodeReviewAction) -> StepResult:
        ...
        # All graders now return a float
        reward = grader.score(
            action.response, 
